...
TEST_CASE("integerPartitions")
{
	...
	CHECK(integerPartitions(16, 6, 2) == ptn{{6,2,2,2,2,2 },{5,3,2,2,2,2},{4,4,2,2,2,2},{4,3,3,2,2,2},{3,3,3,3,2,2}});
...
TEST_CASE("partitionString")
{
	...
	CHECK(partitionString(tc_1234, {1,1,1,1}) == svv{{tc_1234+0,1},{tc_1234+1,1},{tc_1234+2,1},{tc_1234+3,1}});
	CHECK(partitionString(tc_1234, {2,2}) == svv{{tc_1234+0,2},{tc_1234+2,2}});
